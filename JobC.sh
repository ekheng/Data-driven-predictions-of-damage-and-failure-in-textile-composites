...
abaqus job=RefinedElasticC input=/gpfs/accounts/awaas_root/awaas1/ekheng/BatchRun/RefinedElasticC interactive \
...
sbatch --dependency=afterany:$SLURM_JOB_ID  /gpfs/accounts/awaas_root/awaas1/ekheng/BatchRun/JobD.sh